            ...
            <div className="app-main-layout-header">
              <div className="app-main-layout-wrapper header">
                <div className="page-heading">
                  ...
                  <InputLabel size={24} className="wallet-code" >44.444.44</InputLabel>
                </div>
                ...
                */}
                    ...
                    <div className="w-row">
                      <div className="column-2 w-col w-col-4">
                        <a id="stake-id" onClick={(e) => setUnstake(true)} className="button-3 w-button">Stake</a>
                      </div>
                      <div className="column-3 w-col w-col-4">
                        <a id="unstake-id" onClick={(e) => setUnstake(false)} className="button-3 w-button">Unstake</a>
                      </div>
                    </div>
